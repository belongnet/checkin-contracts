...
import { InstanceInfoStruct, NFTV2 as NFT, NftParametersStruct, DynamicPriceParametersV2Struct as DynamicPriceParametersStruct, StaticPriceParametersV2Struct as StaticPriceParametersStruct } from "../typechain-types/contracts/NFTV2";
...
describe('NFT', () => {
	...
	async function fixture() {
		...
		const nft_eth: NFT = await ethers.getContractAt("NFTV2", (await factory.getNftInstanceInfo(
		...
		const nft_erc20: NFT = await ethers.getContractAt("NFTV2", (await factory.getNftInstanceInfo(
			ethers.utils.solidityKeccak256(
				['string', 'string'],
