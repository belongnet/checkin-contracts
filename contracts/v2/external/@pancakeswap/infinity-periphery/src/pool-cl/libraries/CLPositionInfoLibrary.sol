...
library CLPositionInfoLibrary {
    ...
    CLPositionInfo internal constant EMPTY_POSITION_INFO =
        CLPositionInfo.wrap(0);
    ...
    function setSubscribe(
        CLPositionInfo info
    ) internal pure returns (CLPositionInfo _info) {
        assembly ("memory-safe") {
    ...
    function initialize(
        ...
        int24 _tickLower,
        int24 _tickUpper
    ) internal pure returns (CLPositionInfo info) {
