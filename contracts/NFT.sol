 ...
 */
    ...
    function mint(
        ...
        require(
            _verifySignature(receiver, tokenId, tokenUri, whitelisted, signature),
            "Invalid signature"
        );
        ...
        payable(platformAddress).transfer(commission - referralCommission);

        // Existing mint logic for payment handling...
        uint256 amount;
