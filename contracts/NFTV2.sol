...
import {StaticPriceParametersV2, DynamicPriceParametersV2, NftParameters, InvalidSignature} from "./Structures.sol";
 ...
 */
contract NFTV2 is ERC721, ERC2981, Ownable, CreatorToken {
    ...
    function mintStaticPrice(
        address receiver,
        StaticPriceParametersV2[] calldata paramsArray,
    ...
    function mintDynamicPrice(
        address receiver,
        DynamicPriceParametersV2[] calldata paramsArray,
        address expectedPayingToken
    ) external payable {
        require(
            paramsArray.length <=
