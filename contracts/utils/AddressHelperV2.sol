...
import {InstanceInfo, StaticPriceParametersV2, DynamicPriceParametersV2} from "../Structures.sol";
...
library AddressHelperV2 {
    ...
    function checkDynamicPriceParameters(
        address signer,
        address receiver,
        DynamicPriceParametersV2 calldata params
    ) internal view {
        require(
    ...
    function checkStaticPriceParameters(
        address signer,
        address receiver,
        StaticPriceParametersV2 calldata params
    ) internal view {
        require(
            signer.isValidSignatureNow(
                keccak256(
