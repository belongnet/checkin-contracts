# ICLNotifier
[Git Source](https://gitlab.com/nomadhub/smart-contracts/blob/9a5d5791960776da326b790b7c18e7af6b05a3aa/contracts/v2/external/@pancakeswap/infinity-periphery/src/pool-cl/interfaces/ICLNotifier.sol)
...
|Name|Type|Description|
|----|----|-----------|
|`subscriber`|`ICLSubscriber`|the subscriber contract|
...
will revert if vault is locked
