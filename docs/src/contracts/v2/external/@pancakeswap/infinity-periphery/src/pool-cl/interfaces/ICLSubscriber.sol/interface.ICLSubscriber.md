# ICLSubscriber
[Git Source](https://gitlab.com/nomadhub/smart-contracts/blob/e023936db04d0b7e2f5bfdf55b2bcf9f827cb12c/contracts/v2/external/@pancakeswap/infinity-periphery/src/pool-cl/interfaces/ICLSubscriber.sol)

Interface that a Subscriber contract should implement to receive updates from infinity cl pool position manager
...
|`info`|`CLPositionInfo`|information about the position|
...
feesAccrued can be artificially inflated by a malicious user
